    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="relative">
          <div className="relative rounded-[3rem] overflow-hidden aspect-[4/5] max-w-lg mx-auto lg:mx-0 shadow-2xl border-8 border-gray-50 group">
            <img
            ...
            <div className="absolute bottom-4 left-4 right-4 md:bottom-10 md:left-10 md:right-10">
               <div className="bg-white/95 backdrop-blur-md rounded-2xl p-5 md:p-8 shadow-xl border-l-[4px] md:border-l-[6px] border-[#de1c21]">
                  <div className="text-[#0e5872] font-black text-xl md:text-2xl mb-2 leading-tight">{ABOUT_DOCTOR.name}</div>
                  <div className="text-[#de1c21] text-xs md:text-base font-bold uppercase tracking-widest leading-tight">{ABOUT_DOCTOR.degree}</div>
               </div>
            </div>
          </div>
