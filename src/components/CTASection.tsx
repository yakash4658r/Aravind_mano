...
export const CTASection: React.FC = () => {
  return (
    <section className="bg-[#182855] text-white relative overflow-hidden" aria-label="Call to action">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12 lg:gap-24">
          
          {/* Text Content */}
          <div className="flex-1 py-8 md:py-12 z-10 text-center md:text-left">
            <h2 className="text-3xl md:text-[38px] font-bold text-white leading-tight mb-4 tracking-tight px-2 md:px-0">
              Take the First Step Toward Advanced Gastro & Cancer Care
            </h2>
            <p className="text-white/80 text-[15px] leading-relaxed mb-4 px-4 md:px-0">
            ...
            <div className="mb-6 text-white/90 text-sm px-4 md:px-0">
              <span className="block mb-1 font-semibold">Specializing in:</span>
          ...
          {/* Doctor Image */}
          <div className="w-full md:w-5/12 lg:w-4/12 flex justify-center md:justify-end self-end pt-2 md:pt-0 pb-0 z-10 relative">
